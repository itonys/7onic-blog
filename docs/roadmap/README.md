...
| `planned/PUBLISH-SCRIPT-HARDENING-PLAN.md` | `publish-post.ts` 강화 (타임아웃/재시도/에러 계층) | ai-project BACKEND-RULES §1·§3·§10 적용 시 |
| `planned/BLOG-SAAS-PLAN.md` | 블로그 → SaaS 확장 (장기 비전) | 개인 블로그 누적 데이터 확보 후 |
