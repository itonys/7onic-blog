...
| 변경 종류 | 갱신 대상 |
|---|---|
| 새 포스트 게시 | `docs/state/POST-INDEX.md` — 제목·slug·dev.to/Hashnode ID·날짜 기록 |
| 새 포스트 게시 | `docs/state/CONTENT-PLAN.md` — 해당 항목 ✅ 완료로 변경 |
| 콘텐츠 규칙 변경 | `docs/rules/CONTENT-RULES.md` (SSOT — ai-project에서 절대경로로 참조) |
| 새 시리즈 추가 | `docs/state/CONTENT-PLAN.md` — 시리즈 섹션 추가 |
...
| 페이지 레이아웃 규칙 변경 | `CLAUDE.md` (블로그) + `docs/templates/PAGE-TEMPLATE.astro` + `docs/templates/PAGE-TEMPLATE-LIST.astro` 갱신 |
